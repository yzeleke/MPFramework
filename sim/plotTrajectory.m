...
function plotTrajectory(Planner, color_index)
    ...
    if color_index == 1
        ...
        rectangle('Position',[obstacle.rrSafeX,obstacle.rrSafeY,obstacle.safeDistanceX + obstacle.Length,obstacle.safeDistanceY + obstacle.Width],'EdgeColor','y'); %safety region
        hold on
